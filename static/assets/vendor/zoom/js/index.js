...
function websdkready() {
    ...
    var SDK_KEY = "gNBJa0f2UQun2QYsoXUEuwSnRcC1Ww0g6IqP";
    /**
     ...
     */
    var SDK_SECRET = "Uh6cT1GQbqQfMmbGEAcBc58IloARIZ2MBd6F";
        ...
        .addEventListener("click", function (e) {
            ...
            var signature = ZoomMtg.generateSDKSignature({
                ...
                success: function (res) {
                    ...
                    // var joinUrl = "/home/shedd/Downloads/zoom-sdk-web-2.7.0/CDN/meeting.html?" + testTool.serialize(meetingConfig);
                    var joinUrl = "http://localhost:8001/zoom/meeting";
                    console.log(joinUrl);
